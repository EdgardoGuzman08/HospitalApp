...
const EditarRecetas = ({ navigation }) => {
    ...
    const [validarIdRecetas, setvalidarIdRecetas] = useState(false);
    const [id, setIdRecetas] = useState(false);
    ...
    const titulo='Editar Recetas';

    useEffect(() => {

        if (!id) {
            setvalidarIdRecetas(true);
        }
        else {
            setvalidarIdRecetas(false);
        }
    ...
    }, [id, tratamiento, edad, fechaEmitida, UsuariosPacienteId, MedicoId]);
    ...
    const EditarReceta = async () => {
        ...
        if (tratamiento) {
            await Axios.put(
                ...
                console.log(json);
                Alert.alert('Editar Recetas', 'Se guardó con exito');
            }).catch((er) => {
                console.log(er);
            ...
            Alert.alert('Editar Recetas', 'Se deben ingresar los datos correctamente');
        }
    }
                    ...
                    espera ? (
                        ...
                        <>
                            <View style={Estilos.contenedorControlesPantalla}>
                                <TextInput style={validarIdRecetas ? Estilos.entradaError : Estilos.entradaPantalla}
                                    placeholder='Escriba id de la receta'
                                    placeholderTextColor='green'
                                    value={id}
                                    onChangeText={setIdRecetas}
                                >
                                </TextInput>
                                {
                                    validarIdRecetas ? (
                                        <>
                                            <Text style={Estilos.etiquetaError}>Dede escribir el id de la receta</Text>
                                        </>
