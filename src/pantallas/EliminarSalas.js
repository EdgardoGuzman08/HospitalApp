...
const EliminarSalas = ({ navigation }) => {
    ...
    const EliminarSala= async()=>{
        ...
        if (!validarId) {
            await Axios.delete(
                '/salas/eliminar?id='+id
                
            ).then((data) => {
                const json = data.data;
                console.log(json);
                Alert.alert('Eliminar Salas', 'Se elimino con exito');
            }).catch((er) => {
                console.log(er);
            ...
            Alert.alert('Eliminar Salas', 'Se deben ingresar los datos correctamente');
        }
    }
    return (
