...
const EliminarPacientes = ({ navigation }) => {
...
useEffect(()=>{
    ...
    const titulo='Eliminar Pacientes';
    ...
    const deletePaciente= async()=>{
        ...
        if (!validarId) {
            await Axios.delete(
                '/pacientes/eliminar?id='+id
                
            ).then((data) => {
                const json = data.data;
                console.log(json);
                Alert.alert('Eliminar Pacientes', 'Se elimino con exito');
            }).catch((er) => {
                console.log(er);
            ...
            Alert.alert('Eliminar Pacientes', 'Se deben ingresar los datos correctamente');
        }
    }
    return (
