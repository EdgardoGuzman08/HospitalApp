...
import Citas from '../componetes/Citas';
...
const ListarCitas = ({ navigation }) => {
    ...
    const BuscarTipo = async () => {
        if (!validarFiltro) {
            var textoMensaje = '';
            setEspera(true);
            await Axios.get('/citas/buscarfecha?fechaAtencion=' + Filtro + '%')
                .then(async (data) => {
                    ...
                    espera ? (
                        ...
                        <>
                            ...
                            <View style={Estilos.contenedorControles}>
                                <FlatList
                                    data={lista}
                                    renderItem={({ item }) => <Citas cita={item}></Citas>}
